...
[**🖥️미리보기 (Vercel)**](https://isandrel.com)
...
- [x] [Markdown 확장 기능](https://github.com/isandrel/fuwari?tab=readme-ov-file#-markdown-extended-syntax)
- [x] 목차
- [x] RSS 피드

## 🚀 시작하기
1. 블로그 저장소를 생성하세요:
   - 이 템플릿에서 [새 저장소를 생성](https://github.com/isandrel/fuwari/generate)하거나 이 저장소를 포크하세요.
...
- Admonitions ([미리보기 및 사용법](https://isandrel.com/posts/markdown-extended/#admonitions))
- GitHub 저장소 카드 ([미리보기 및 사용법](https://isandrel.com/posts/markdown-extended/#github-repository-cards))
- Expressive Code를 사용한 향상된 코드 블록 ([미리보기](https://isandrel.com/posts/expressive-code/) / [문서](https://expressive-code.com/))
...
## ✏️ 기여
이 프로젝트에 기여하는 방법에 대한 자세한 내용은 [기여 가이드](https://github.com/isandrel/fuwari/blob/main/CONTRIBUTING.md)를 확인하세요.
