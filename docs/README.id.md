...
[**🖥️ Demo Langsung (Vercel)**](https://isandrel.com)
...
- Admonisi ([Pratinjau & Cara Pakai](https://isandrel.com/posts/markdown-extended/#admonitions))
- Kartu repositori GitHub ([Pratinjau & Cara Pakai](https://isandrel.com/posts/markdown-extended/#github-repository-cards))
- Kode blok ekspresif lewat Expressive Code ([Pratinjau](https://isandrel.com/posts/expressive-code/) / [Dokumentasi](https://expressive-code.com/))
